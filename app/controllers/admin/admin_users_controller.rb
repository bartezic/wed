  ...
  class AdminUsersController < BaseController
    ...
    def create
      ...
      respond_to do |format|
        if @admin_user.save && update_translations
    ...
    def update
      respond_to do |format|
        if update_translations && @admin_user.update(admin_user_params)
    ...
    private
      ...
      def admin_user_params
        params.require(:admin_user).permit(:name, :email, :avatar, :avatar_remote_url, :password, :password_confirmation)
      end

      def update_translations
        params[:admin_user][:translations].values.each do |translation|
          I18n.locale = translation['locale'].to_sym
          @admin_user.update( name: translation['name'] )
        end
      end
  end
end